...
public class Menu extends GameObject{
	...
	public void pausedEvent () {
		...
		if (keyPressed ('D') && pageNumber !=4 && iterateTab) {
			if (pageNumber == 0) {
				...
				upgradeBox3 = new Tbox(this.getX() + 145 - Room.getViewX(), this.getY() + 335, 20, 4,GameCode.testJeffrey.getInventory().findWeaponAtIndex(weaponIndex).getUpgrades() [2],false);
				upgradeBox3.setScrollRate(0);
				upgradeBox4 = new Tbox(this.getX() + 35 - Room.getViewX(), this.getY() + 400, 12, 4,GameCode.testJeffrey.getInventory().findWeaponAtIndex(weaponIndex).getUpgrades() [3],false);
				upgradeBox4.setScrollRate(0);
				ammoBox = new Tbox(this.getX() + 35 - Room.getViewX(), this.getY() + 275, 12, 2,"AMMO " + Integer.toString(GameCode.testJeffrey.getInventory().checkAmmoAmountOfWeapon(GameCode.testJeffrey.getInventory().findWeaponAtIndex(weaponIndex))),false);
				ammoBox.setScrollRate(0);
				weaponNameBox.keepOpen(true);
		...
		if (pageNumber == 3) {
			if (keyPressed (32) && enemyPosition != -1) {
				...
				detailedEnemyName = new Tbox (this.getX() + 175 - Room.getViewX(), this.getY() + 125, 40, 1, GameCode.testJeffrey.getInventory().findEnemyAtIndex(enemyIndex2).checkName(), false);
				detailedEnemyEntry = new Tbox (this.getX() + 337 - Room.getViewX(), this.getY() + 155, 18, 18, GameCode.testJeffrey.getInventory().findEnemyAtIndex(enemyIndex2).checkEntry(), false);
				}
				if (enemyPosition == 2) {
					AfterRenderDrawer.drawAfterRender((int)this.getX() + 250 - Room.getViewX(), (int)this.getY() + 225, GameCode.testJeffrey.getInventory().findEnemyAtIndex(enemyIndex3).getSprite(),0, true);
					detailedEnemyName = new Tbox (this.getX() + 175 - Room.getViewX(), this.getY() + 125, 40, 1, GameCode.testJeffrey.getInventory().findEnemyAtIndex(enemyIndex3).checkName(), false);
					detailedEnemyEntry = new Tbox (this.getX() + 337 - Room.getViewX(), this.getY() + 155, 18, 18, GameCode.testJeffrey.getInventory().findEnemyAtIndex(enemyIndex3).checkEntry(), false);
				}
				if (enemyPosition == 3) {
					AfterRenderDrawer.drawAfterRender((int)this.getX() + 250 - Room.getViewX(), (int)this.getY() + 225, GameCode.testJeffrey.getInventory().findEnemyAtIndex(enemyIndex4).getSprite(),0, true);
					detailedEnemyName = new Tbox (this.getX() + 175 - Room.getViewX(), this.getY() + 125, 40, 1, GameCode.testJeffrey.getInventory().findEnemyAtIndex(enemyIndex4).checkName(), false);
					detailedEnemyEntry = new Tbox (this.getX() + 337 - Room.getViewX(), this.getY() + 155, 18, 18, GameCode.testJeffrey.getInventory().findEnemyAtIndex(enemyIndex4).checkEntry(), false);
				}
	...
	public void showEnemyList () {
		int beforeCrash = 0;
		try {
			AfterRenderDrawer.drawAfterRender((int)this.getX() + 55 - Room.getViewX(), (int)this.getY() + 185,GameCode.testJeffrey.getInventory().findEnemyAtIndex(enemyIndex1).getSprite(), 0, true);
			enemyName1 = new Tbox(this.getX() + 165 - Room.getViewX(), this.getY() + 155, 30, 4,GameCode.testJeffrey.getInventory().findEnemyAtIndex(enemyIndex1).checkName(),false);
			enemyName1.setScrollRate(0);
			beforeCrash = 1;
			AfterRenderDrawer.drawAfterRender((int)this.getX() + 55 - Room.getViewX(), (int)this.getY() + 245,GameCode.testJeffrey.getInventory().findEnemyAtIndex(enemyIndex2).getSprite(), 0, true);
			enemyName2 = new Tbox(this.getX() + 165 - Room.getViewX(), this.getY() + 225, 30, 4,GameCode.testJeffrey.getInventory().findEnemyAtIndex(enemyIndex2).checkName(),false);
			enemyName2.setScrollRate(0);
			beforeCrash = 2;
			AfterRenderDrawer.drawAfterRender((int)this.getX() + 55 - Room.getViewX(), (int)this.getY() +  315,GameCode.testJeffrey.getInventory().findEnemyAtIndex(enemyIndex3).getSprite(), 0, true);
			enemyName3 = new Tbox(this.getX() + 165 - Room.getViewX(), this.getY() + 295, 30, 4,GameCode.testJeffrey.getInventory().findEnemyAtIndex(enemyIndex3).checkName(),false);
			enemyName3.setScrollRate(0);
			beforeCrash = 3;
			AfterRenderDrawer.drawAfterRender((int)this.getX() + 55 - Room.getViewX(), (int)this.getY() + 400,GameCode.testJeffrey.getInventory().findEnemyAtIndex(enemyIndex4).getSprite(), 0, true);
			enemyName4 = new Tbox(this.getX() + 165 - Room.getViewX(), this.getY() + 365, 30, 4,GameCode.testJeffrey.getInventory().findEnemyAtIndex(enemyIndex4).checkName(),false);
	...
	public void showItemList (boolean consumablesOrKey) {
		...
		if (consumablesOrKey) {
		try {
			AfterRenderDrawer.drawAfterRender((int)this.getX() + 55 - Room.getViewX(), (int)this.getY() + 185,GameCode.testJeffrey.getInventory().getSortedConsumablesAndAmmo().get(itemIndex1).getSprite(), 0, true);
			itemName1 = new Tbox(this.getX() + 105 - Room.getViewX(), this.getY() + 155, 20, 4,GameCode.testJeffrey.getInventory().getSortedConsumablesAndAmmo().get(itemIndex1).checkName() + " X " + Integer.toString(GameCode.testJeffrey.getInventory().checkItemAmount(GameCode.testJeffrey.getInventory().getSortedConsumablesAndAmmo().get(itemIndex1))),false);
			itemName1.setScrollRate(0);
			beforeCrash = 1;
			AfterRenderDrawer.drawAfterRender((int)this.getX() + 55 - Room.getViewX(), (int)this.getY() + 245,GameCode.testJeffrey.getInventory().getSortedConsumablesAndAmmo().get(itemIndex2).getSprite(), 0, true);
			itemName2 = new Tbox(this.getX() + 105 - Room.getViewX(), this.getY() + 225, 20, 4,GameCode.testJeffrey.getInventory().getSortedConsumablesAndAmmo().get(itemIndex2).checkName() + " X " + Integer.toString(GameCode.testJeffrey.getInventory().checkItemAmount(GameCode.testJeffrey.getInventory().getSortedConsumablesAndAmmo().get(itemIndex2))),false);
			itemName2.setScrollRate(0);
			beforeCrash = 2;
			AfterRenderDrawer.drawAfterRender((int)this.getX() + 55 - Room.getViewX(), (int)this.getY() +  315,GameCode.testJeffrey.getInventory().getSortedConsumablesAndAmmo().get(itemIndex3).getSprite(), 0, true);
			itemName3 = new Tbox(this.getX() + 105 - Room.getViewX(), this.getY() + 295, 20, 4,GameCode.testJeffrey.getInventory().getSortedConsumablesAndAmmo().get(itemIndex3).checkName() + " X " + Integer.toString(GameCode.testJeffrey.getInventory().checkItemAmount(GameCode.testJeffrey.getInventory().getSortedConsumablesAndAmmo().get(itemIndex3))),false);
			itemName3.setScrollRate(0);
			beforeCrash = 3;
			AfterRenderDrawer.drawAfterRender((int)this.getX() + 55 - Room.getViewX(), (int)this.getY() + 400,GameCode.testJeffrey.getInventory().getSortedConsumablesAndAmmo().get(itemIndex4).getSprite(), 0, true);
			itemName4 = new Tbox(this.getX() + 105 - Room.getViewX(), this.getY() + 370, 20, 4,GameCode.testJeffrey.getInventory().getSortedConsumablesAndAmmo().get(itemIndex4).checkName() + " X " + Integer.toString(GameCode.testJeffrey.getInventory().checkItemAmount(GameCode.testJeffrey.getInventory().getSortedConsumablesAndAmmo().get(itemIndex4))),false);
			...
			try {
				AfterRenderDrawer.drawAfterRender((int)this.getX() + 55 - Room.getViewX(), (int)this.getY() + 185,GameCode.testJeffrey.getInventory().getSortedKey().get(itemIndex5).getSprite(), 0, true);
				itemName1 = new Tbox(this.getX() + 105 - Room.getViewX(), this.getY() + 155, 20, 4,GameCode.testJeffrey.getInventory().getSortedKey().get(itemIndex5).checkName()+ " X " + Integer.toString(GameCode.testJeffrey.getInventory().checkItemAmount(GameCode.testJeffrey.getInventory().getSortedKey().get(itemIndex5))),false);
				itemName1.setScrollRate(0);
				beforeCrash =1;
				AfterRenderDrawer.drawAfterRender((int)this.getX() + 55 - Room.getViewX(), (int)this.getY() + 245,GameCode.testJeffrey.getInventory().getSortedKey().get(itemIndex6).getSprite(), 0, true);
				itemName2 = new Tbox(this.getX() + 105 - Room.getViewX(), this.getY() + 225, 20, 4,GameCode.testJeffrey.getInventory().getSortedKey().get(itemIndex6).checkName() + " X " + Integer.toString(GameCode.testJeffrey.getInventory().checkItemAmount(GameCode.testJeffrey.getInventory().getSortedKey().get(itemIndex6))),false);
				itemName2.setScrollRate(0);
				beforeCrash = 2;
				AfterRenderDrawer.drawAfterRender((int)this.getX() + 55 - Room.getViewX(), (int)this.getY() +  315,GameCode.testJeffrey.getInventory().getSortedKey().get(itemIndex7).getSprite(), 0, true);
				itemName3 = new Tbox(this.getX() + 105 - Room.getViewX(), this.getY() + 295, 20, 4,GameCode.testJeffrey.getInventory().getSortedKey().get(itemIndex7).checkName() + " X " + Integer.toString(GameCode.testJeffrey.getInventory().checkItemAmount(GameCode.testJeffrey.getInventory().getSortedKey().get(itemIndex7))),false);
				itemName3.setScrollRate(0);
				beforeCrash = 3;
				AfterRenderDrawer.drawAfterRender((int)this.getX() + 55 - Room.getViewX(), (int)this.getY() + 400,GameCode.testJeffrey.getInventory().getSortedKey().get(itemIndex8).getSprite(), 0, true);
				itemName4 = new Tbox(this.getX() + 105 - Room.getViewX(), this.getY() + 370, 20, 4,GameCode.testJeffrey.getInventory().getSortedKey().get(itemIndex8).checkName() + " X " + Integer.toString(GameCode.testJeffrey.getInventory().checkItemAmount(GameCode.testJeffrey.getInventory().getSortedKey().get(itemIndex8))),false);
				itemName4.setScrollRate(0);
			} catch(IndexOutOfBoundsException e) {
				if (beforeCrash == 0) {
					itemName1 = new Tbox();
	...
	public void setUpNewPlayableCharictar () {
		...
		for (int i = 0; i <4; i++) {
			if (!GameCode.testJeffrey.getInventory().findWeaponAtIndex(i, 0).getClass().getSimpleName().equals("Unarmed")) {
				AfterRenderDrawer.drawAfterRender((int)(this.getX() + 180 + (i*60))- Room.getViewX() , (int)this.getY() + 320,GameCode.testJeffrey.getInventory().findWeaponAtIndex(i, 0).getUnrotatedSprite(), 0, true);
			} else {
		...
		if (GameCode.testJeffrey.getInventory().findFreindAtIndex(charictarIndex).checkName().equals("SAM")) {
			...
			for (int i = 0; i <4; i++) {
				if (!GameCode.testJeffrey.getInventory().findWeaponAtIndex(i, 1).getClass().getSimpleName().equals("Unarmed")) {
					AfterRenderDrawer.drawAfterRender((int)(this.getX() + 180 + (i*60)) - Room.getViewX() , (int)this.getY() + 320,GameCode.testJeffrey.getInventory().findWeaponAtIndex(i, 1).getUnrotatedSprite(), 0, true);
				} else {
					AfterRenderDrawer.drawAfterRender((int)(this.getX() + 180 + (i*60)) - Room.getViewX() , (int)this.getY() + 320,questionMark, 0, true);	
				}
			}
		...
		if (GameCode.testJeffrey.getInventory().findFreindAtIndex(charictarIndex).checkName().equals("RYAN")) {
			...
			for (int i = 0; i <4; i++) {
				if (!GameCode.testJeffrey.getInventory().findWeaponAtIndex(i, 2).getClass().getSimpleName().equals("Unarmed")) {
					AfterRenderDrawer.drawAfterRender((int)(this.getX() + 180 + (i*60)) - Room.getViewX(), (int)this.getY() + 320,GameCode.testJeffrey.getInventory().findWeaponAtIndex(i, 2).getUnrotatedSprite(), 0, true);
				} else {
					AfterRenderDrawer.drawAfterRender((int)(this.getX() + 180 + (i*60))- Room.getViewX() , (int)this.getY() + 320,questionMark, 0, true);	
				}
			}
