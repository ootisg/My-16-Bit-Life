...
public class Gui extends GameObject {
	...
	public void frameEvent () {
		if (keyPressed ('E')) {
			...
			//GameLoop.pause (); TODO implement pausing
		}
		if (mainMenu != null && mainMenu.declared ()) {
			pausedEvent ();
		}
	}
	public void pausedEvent () {
		...
		if (selectedVal == 2) {
			...
			//MainLoop.resume (); TODO implemet resuming
		}
	}
	...
	public void draw () {
		...
		//Graphics buffer = MainLoop.getWindow ().getBuffer (); TODO Git gud
