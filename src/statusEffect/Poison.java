...
public class Poison extends GameObject{
	...
	public Poison (Jeffrey affected, Status state, int tier){
		...
		effectTimer = 0;
		level = tier;
		affectedMAN.walkSprite = Jeffrey.jeffreyWalkingPoisoned;
		affectedMAN.standSprite = Jeffrey.jeffreyIdlePoisoned;
	}
	@Override
	public void frameEvent (){
		...
		if (effectTimer == 600){
			affectedMAN.walkSprite = Jeffrey.jeffreyWalking;
			affectedMAN.standSprite = Jeffrey.jeffreyIdle;
			this.forget();
			}
	}
}
