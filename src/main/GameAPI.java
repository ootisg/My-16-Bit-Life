...
public abstract class GameAPI {
	...
	public static final GameWindow window = RenderLoop.window;
	...
	public int getCursorX () {
		return (int) (GameLoop.getInputImage ().getCursorX () * window.getResolution () [0]);
	}
	...
	public int getCursorY () {
		return (int) (GameLoop.getInputImage ().getCursorY () * window.getResolution () [1]);
	}
